...
function peg$parse(input, options) {
  ...
  const peg$e77 = peg$classExpectation(
    [['a', 'z'], ['A', 'Z'], ['0', '9'], '_', '-'],
    false,
    false,
    false,
  ...
  function peg$f99(char) {
    return char
  }
  function peg$f100(seq) {
    return seq
  }
  function peg$f101(char) {
    return char
  }
  function peg$f102(seq) {
    return seq
  }
  function peg$f103() {
    return '\n'
                                              ...
                                              if (s1 === peg$FAILED) {
                                                ...
                                                if (s1 === peg$FAILED) {
                                                  ...
                                                  if (s1 === peg$FAILED) {
                                                    ...
                                                    if (s1 === peg$FAILED) {
                                                      if (
                                                        input.substr(peg$currPos, 6) === peg$c46
                                                      ) {
                                                        s1 = peg$c46
                                                        peg$currPos += 6
                                                      } else {
                                                      ...
                                                      if (s1 === peg$FAILED) {
                                                        if (
                                                          input.substr(peg$currPos, 5) === peg$c47
                                                        ) {
                                                          s1 = peg$c47
                                                          peg$currPos += 5
                                                        } else {
                                                        ...
                                                        if (s1 === peg$FAILED) {
                                                          if (
                                                            input.substr(peg$currPos, 5) === peg$c49
                                                          ) {
                                                            s1 = peg$c49
                                                            peg$currPos += 5
                                                          } else {
