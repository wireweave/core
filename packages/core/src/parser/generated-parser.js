...
function peg$parse(input, options) {
  ...
  function peg$f11(name, value) {
    return createNamedValue(name, value)
  }
  function peg$f12(namespace) {
    return namespace
  }
  function peg$f13(fills) {
    return fills.map((item) => item[0])
  }
  ...
  function peg$f53(values) {
    return { kind: 'columns', values }
  }
  function peg$f54(values) {
  ...
  function peg$f98(chars) {
    return chars.join('')
  }
  function peg$f99(chars) {
    return chars.join('')
  }
  function peg$f100(char) {
    return char
  }
  function peg$f101(seq) {
    return seq
  }
  function peg$f102(char) {
    return char
  }
  function peg$f103(seq) {
    return seq
  }
  function peg$f104() {
    return '\n'
                                              ...
                                              if (s1 === peg$FAILED) {
                                                ...
                                                if (s1 === peg$FAILED) {
                                                  ...
                                                  if (s1 === peg$FAILED) {
                                                    ...
                                                    if (s1 === peg$FAILED) {
                                                      if (
                                                        input.substr(peg$currPos, 6) === peg$c47
                                                      ) {
                                                        s1 = peg$c47
                                                        peg$currPos += 6
                                                      } else {
                                                      ...
                                                      if (s1 === peg$FAILED) {
                                                        if (
                                                          input.substr(peg$currPos, 5) === peg$c48
                                                        ) {
                                                          s1 = peg$c48
                                                          peg$currPos += 5
                                                        } else {
                                                        ...
                                                        if (s1 === peg$FAILED) {
                                                          if (
                                                            input.substr(peg$currPos, 5) === peg$c50
                                                          ) {
                                                            s1 = peg$c50
                                                            peg$currPos += 5
                                                          } else {
